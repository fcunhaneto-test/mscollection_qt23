...
class SearchMSMediaYear(QMdiSubWindow):
    ...
    def resizeEvent(self, event):
        ...
        if self.type == 'movie':
            ...
            self.table.setColumnWidth(3, 0.2 * col_width)
    ...
    def view_obj(self, row, col):
        ...
        if self.row_select != row and col == 0:
            if self.type == 'movie':
                ...
                obj_id = self.table.item(row, 4).text()
        ...
        for o in objs:
            ...
            if o.original_name:
                self.table.setItem(self.rows, 1,
                                   QTableWidgetItem(o.original_name))
            else:
            ...
            if self.type == 'movie':
                ...
                self.table.setItem(self.rows, 3, QTableWidgetItem(o.year))
                self.table.setItem(self.rows, 4, QTableWidgetItem(str(o.id)))
