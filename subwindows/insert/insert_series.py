...
from db.db_model import Creator, Keyword, Series, SeriesCreator, SeriesCast
...
class InsertSeries(QMdiSubWindow):
    ...
    def __init__(self, main):
        ...
        self.pb_search_imdb.clicked.\
            connect(lambda type: self.set_series_scrapping('imdb'))
        ...
        self.pb_search_ad = pb_create(
            texts.pb_imdb_ad_search, height=25, width=200)
        self.pb_search_ad.clicked.connect(lambda type: self.set_series_scrapping('ad'))
        ...
        self.fm_1.setWidget(4, QFormLayout.LabelRole, self.lb_keyword)
        self.fm_1.setWidget(4, QFormLayout.FieldRole, self.cb_keyword)
        ...
        self.fm_2.setWidget(1, QFormLayout.LabelRole, self.lb_creator)
        self.fm_2.setWidget(1, QFormLayout.FieldRole, self.cb_creator)

        self.lb_seasons = QLabel(texts.season_p)
        self.le_seasons = le_create(10, texts.season_num_tt)
        self.fm_2.setWidget(2, QFormLayout.LabelRole, self.lb_seasons)
        self.fm_2.setWidget(2, QFormLayout.FieldRole, self.le_seasons)
        ...
        self.pb_save.clicked.connect(self.insert_series)
        ...
        self.setTabOrder(self.le_year, self.cb_creator)
    ...
    def insert_series(self):
        ...
        if not self.le_title.text():
            ...
            self.series.web_url = self.le_url.text()
            ...
            self.series.date_edit = hour_now
    ...
    def refresh_combobox(self):
        ...
        populate_combobox(self.cb_category_1, category)
        populate_combobox(self.cb_category_2, category)
        populate_combobox(self.cb_creator, db_select_all(self.session, Creator))
        self.clear_table()
    ...
    def search_confirmed_imdb(self):
        ...
        self.le_imdb_url.returnPressed. \
            connect(lambda type='imdb': self.set_series_scrapping(type))
        self.le_ad_url.setEnabled(False)
        self.le_ad_url.setHidden(True)
    ...
    def search_confirmed_ad(self):
        ...
        self.le_ad_url.returnPressed. \
            connect(lambda type='ad': self.set_series_scrapping(type))
        self.pb_search_imdb.setEnabled(False)
        self.pb_search_imdb.setHidden(True)
    ...
    # Scrapping
    def set_series_scrapping(self, type):
        """
        Scrapping series values in "IMDB" site or "Adoro Cinema" site according give
        type.
    ...
    def help(self):
        ...
        dir = os.getcwd()
        url = 'file:///' + dir + '/views_help/help_insert_series_series.html'
